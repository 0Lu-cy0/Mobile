...
// import { saveTaskToFirebase } from "@/services/dataTask"
...
//         // if (selectedTask) {
//         //     const updatedTasks = tasks.map((task: { name: string; status: boolean }) => task.name === selectedTask.name ? { ...task, name: nameTask } : task
//         //     );
...
//         // if (selectedTask) {
//         //     const filteredTasks = tasks.filter((task: { name: string; status: boolean }) => task.name !== selectedTask.name);
...
//                     renderItem={({ item, index }: { item: { name: string; deadlineDay: string; deadlineTime: string; status: boolean }; index: number }) => (
//                         <TouchableOpacity
//                             key={index}
